...
@section('title', __('Create New Order'))
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('Create New Order') }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {{ Form::model($order, ['route' => ['dashboard.orders.store'], 'method' => 'post', 'id' => 'order', 'autocomplete' => 'off']) }}
                        <div class="box-body">
                            @if(isset($order->customer_id))
                                <div class="form-group">
                                    {{ Form::label('customer_id', __('Customer') . ':', ['class' => 'control-label']) }}
                                    {{ Form::hidden('customer_id') }}
                                    <h4>{{ $order->customer->company  }}</h4>
                                </div>
                            @else
...
@section('script')
    ...
    <script>
        ...
        $(function () {
            ...
            $('.order-item').focusin(orderItemFocusIn);
