            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {{ Form::model($bill, ['route' => ['dashboard.bills.update', $bill->id], 'method' => 'put', 'id' => 'bill', 'autocomplete' => 'off']) }}
                        {{ Form::hidden('id') }}
                        <div class="box-body">
                                ...
                                @else
                                    @foreach($bill->billItems as $index => $billItem)
                                        <tr class="bill-item" data-index="{{ $index }}">
                                            ...
                                            <td class="capacity {{ $errors->has('billItems.' . $index . '.capacity')? 'has-error' : '' }}">
                                                {{ Form::number('billItems[' . $index . '][capacity]', $billItem->unit->capacity, ['required', 'readonly', 'class' => 'form-control', 'placeholder' => __('Enter Capacity') . '...']) }}
                                                <span
                                                    class="help-block">{{ $errors->first('billItems.' . $index . '.capacity') }}</span>
                                            ...
                                            <td class="total-cost">
                                                {{ $billItem->unit->capacity * $billItem->count * $billItem->cost }}
                                            </td>
                                            <td class="controls">
                                                <a class="btn btn-box-tool toggle-item" data-toggle="tooltip"
                                                   title="{{ __('Enable / Disable') }}" tabindex="-1">
