...
@section('title', __('Edit Customer Payment'))
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ __('Edit Customer Payment') }}</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        {{ Form::model($payment, ['route' => ['dashboard.customerPayments.update', $payment->id], 'method' => 'put', 'autocomplete' => 'off']) }}
                        {{ Form::hidden('id') }}
                        <div class="box-body">
