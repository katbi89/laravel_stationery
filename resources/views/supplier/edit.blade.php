...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-shopping-bag"></i> {{ __('Supplier') }}
                <small>{{ __('Edit') }}</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-default">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {{ Form::model($supplier, ['route' => ['dashboard.suppliers.update', $supplier->id], 'method' => 'put', 'autocomplete' => 'off']) }}
                        {{ Form::hidden('id') }}
                        <div class="box-body">
                            <div class="form-group {{ $errors->has('company')? 'has-error' : '' }}">
                                ...
                                {{ Form::text('company', old('company'), ['required', 'autofocus', 'class' => 'form-control', 'placeholder' => __('Enter Company Name') . '...']) }}
                            ...
                            <div class="form-group {{ $errors->has('name')? 'has-error' : '' }}">
                                ...
                                {{ Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => __('Enter Supplier Name') . '...']) }}
                        ...
                        <div class="box-footer">
                            {{ link_to_route('dashboard.suppliers.index', __('Back'), null, [ 'class' => 'btn btn-default', 'tabindex' => '-1' ]) }}
                            {{ Form::submit(__('Edit'), ['class' => 'btn btn-primary pull-right']) }}
                        </div>
                        <!-- /.box-footer -->
                        {{ Form::close() }}
                    </div>
